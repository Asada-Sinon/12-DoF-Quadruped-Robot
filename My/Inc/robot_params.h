...
#define LINK_LENGTH_CALF  0.2451f
...
#define DEFAULT_CENTER_OF_GRAVITY_ROTATION_PITCH 0.0f
#define DEFAULT_CENTER_OF_GRAVITY_ROTATION_YAW 0.0f
#define DEFAULT_CENTER_OF_GRAVITY_ROTATION_ROLL 0.0f
...
#define DEFAULT_CENTER_OF_GRAVITY_TROT_COG_BACKWARD_OFFSET_X 0.025f
...
#define JOINT_FL_CALF_ANGLE_SPECIAL_POS -29.24f * DEGREE_TO_RADIAN
// #define JOINT_FL_CALF_ANGLE_SPECIAL_POS -27.99f * DEGREE_TO_RADIAN
...
#define JOINT_FR_CALF_ANGLE_SPECIAL_POS -29.24f * DEGREE_TO_RADIAN
// #define JOINT_FR_CALF_ANGLE_SPECIAL_POS -27.99f * DEGREE_TO_RADIAN
...
#define JOINT_HL_CALF_ANGLE_SPECIAL_POS -29.24f * DEGREE_TO_RADIAN
...
#define JOINT_HR_CALF_ANGLE_SPECIAL_POS -29.24f * DEGREE_TO_RADIAN
//#define JOINT_HR_CALF_ANGLE_SPECIAL_POS -31.753f * DEGREE_TO_RADIAN

// 对应的电机坐标系角度（摆好关节位置后从电机回传数据读取出）
 #define MOTOR_FL_HIP_ANGLE_SPECIAL_POS 0.3692f
// #define MOTOR_FL_THIGH_ANGLE_SPECIAL_POS 1.39f
// #define MOTOR_FL_CALF_ANGLE_SPECIAL_POS -2.132f

 #define MOTOR_FR_HIP_ANGLE_SPECIAL_POS -0.4803f
// #define MOTOR_FR_THIGH_ANGLE_SPECIAL_POS -1.05f
// #define MOTOR_FR_CALF_ANGLE_SPECIAL_POS 2.031f

 #define MOTOR_HL_HIP_ANGLE_SPECIAL_POS -0.25142f
// #define MOTOR_HL_THIGH_ANGLE_SPECIAL_POS 0.956f
// #define MOTOR_HL_CALF_ANGLE_SPECIAL_POS -2.12f

 #define MOTOR_HR_HIP_ANGLE_SPECIAL_POS 0.20259f
// #define MOTOR_HR_THIGH_ANGLE_SPECIAL_POS -1.057f
// #define MOTOR_HR_CALF_ANGLE_SPECIAL_POS 2.306f

// 电机起始位置与电机特殊位置的差值(电机特殊位置的相对位置)
//#define MOTOR_FL_HIP_ANGLE_GAP  0.3876f  //0.3109f - -0.0767
#define MOTOR_FL_THIGH_ANGLE_GAP 1.1987f  //1.376f - 0.1773
#define MOTOR_FL_CALF_ANGLE_GAP -2.3049f  //-2.174f - 0.1309

//#define MOTOR_FR_HIP_ANGLE_GAP -0.3828f  //-0.4627f - -0.0799
#define MOTOR_FR_THIGH_ANGLE_GAP -1.2252f  //-1.0544f - 0.1708
#define MOTOR_FR_CALF_ANGLE_GAP 2.2871f  //2.0768f - -0.2103

//#define MOTOR_HL_HIP_ANGLE_GAP -0.3765f  //-0.2058f - 0.1707
#define MOTOR_HL_THIGH_ANGLE_GAP 1.1683f  //0.9537f - -0.2146
#define MOTOR_HL_CALF_ANGLE_GAP -2.2883  //-2.182f - 0.1063

//#define MOTOR_HR_HIP_ANGLE_GAP 0.378f  //0.486f - 0.108
#define MOTOR_HR_THIGH_ANGLE_GAP -1.1566  //-1.042f - 0.1146
#define MOTOR_HR_CALF_ANGLE_GAP 2.2895  //2.37f - 0.0805

//GAP-SPECIAL 初始化时加上初始角度即可 新
//#define MOTOR_FL_HIP_ANGLE_ZERO_POS ( MOTOR_FL_HIP_ANGLE_GAP- MOTOR_FL_HIP_DIRECTION*JOINT_FL_HIP_ANGLE_SPECIAL_POS)
#define MOTOR_FL_HIP_ANGLE_ZERO_POS (MOTOR_FL_HIP_ANGLE_SPECIAL_POS - MOTOR_FL_HIP_DIRECTION*JOINT_FL_HIP_ANGLE_SPECIAL_POS)
#define MOTOR_FL_THIGH_ANGLE_ZERO_POS (MOTOR_FL_THIGH_ANGLE_GAP - MOTOR_FL_THIGH_DIRECTION*JOINT_FL_THIGH_ANGLE_SPECIAL_POS)
#define MOTOR_FL_CALF_ANGLE_ZERO_POS (MOTOR_FL_CALF_ANGLE_GAP - MOTOR_FL_CALF_DIRECTION*JOINT_FL_CALF_ANGLE_SPECIAL_POS)

//#define MOTOR_FR_HIP_ANGLE_ZERO_POS (MOTOR_FR_HIP_ANGLE_GAP - MOTOR_FR_HIP_DIRECTION*JOINT_FR_HIP_ANGLE_SPECIAL_POS)
#define MOTOR_FR_HIP_ANGLE_ZERO_POS (MOTOR_FR_HIP_ANGLE_SPECIAL_POS - MOTOR_FR_HIP_DIRECTION*JOINT_FR_HIP_ANGLE_SPECIAL_POS)
#define MOTOR_FR_THIGH_ANGLE_ZERO_POS (MOTOR_FR_THIGH_ANGLE_GAP - MOTOR_FR_THIGH_DIRECTION*JOINT_FR_THIGH_ANGLE_SPECIAL_POS)
#define MOTOR_FR_CALF_ANGLE_ZERO_POS (MOTOR_FR_CALF_ANGLE_GAP - MOTOR_FR_CALF_DIRECTION*JOINT_FR_CALF_ANGLE_SPECIAL_POS)

//#define MOTOR_HL_HIP_ANGLE_ZERO_POS ( MOTOR_HL_HIP_ANGLE_GAP- MOTOR_HL_HIP_DIRECTION*JOINT_HL_HIP_ANGLE_SPECIAL_POS)
#define MOTOR_HL_HIP_ANGLE_ZERO_POS (MOTOR_HL_HIP_ANGLE_SPECIAL_POS - MOTOR_HL_HIP_DIRECTION*JOINT_HL_HIP_ANGLE_SPECIAL_POS)
#define MOTOR_HL_THIGH_ANGLE_ZERO_POS (MOTOR_HL_THIGH_ANGLE_GAP - MOTOR_HL_THIGH_DIRECTION*JOINT_HL_THIGH_ANGLE_SPECIAL_POS)
#define MOTOR_HL_CALF_ANGLE_ZERO_POS (MOTOR_HL_CALF_ANGLE_GAP - MOTOR_HL_CALF_DIRECTION*JOINT_HL_CALF_ANGLE_SPECIAL_POS)

//#define MOTOR_HR_HIP_ANGLE_ZERO_POS (MOTOR_HR_HIP_ANGLE_GAP - MOTOR_HR_HIP_DIRECTION*JOINT_HR_HIP_ANGLE_SPECIAL_POS)
#define MOTOR_HR_HIP_ANGLE_ZERO_POS (MOTOR_HR_HIP_ANGLE_SPECIAL_POS - MOTOR_HR_HIP_DIRECTION*JOINT_HR_HIP_ANGLE_SPECIAL_POS)
#define MOTOR_HR_THIGH_ANGLE_ZERO_POS (MOTOR_HR_THIGH_ANGLE_GAP - MOTOR_HR_THIGH_DIRECTION*JOINT_HR_THIGH_ANGLE_SPECIAL_POS)
#define MOTOR_HR_CALF_ANGLE_ZERO_POS ( MOTOR_HR_CALF_ANGLE_GAP- MOTOR_HR_CALF_DIRECTION*JOINT_HR_CALF_ANGLE_SPECIAL_POS)
...
typedef struct {
    ...
    float foot_offest_correction[4][3]; // 足端位置补偿，调整这个值使得足端连线成一个正方形
} CenterOfGravity;
