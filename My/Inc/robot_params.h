...
#define MOTOR_FL_CALF_ANGLE_SPECIAL_POS -2.16f

#define MOTOR_FR_HIP_ANGLE_SPECIAL_POS -0.459f
#define MOTOR_FR_THIGH_ANGLE_SPECIAL_POS -1.05f
#define MOTOR_FR_CALF_ANGLE_SPECIAL_POS 2.076f

#define MOTOR_HL_HIP_ANGLE_SPECIAL_POS -0.273f
#define MOTOR_HL_THIGH_ANGLE_SPECIAL_POS 1.285f
#define MOTOR_HL_CALF_ANGLE_SPECIAL_POS -2.176f

#define MOTOR_HR_HIP_ANGLE_SPECIAL_POS 0.174f
#define MOTOR_HR_THIGH_ANGLE_SPECIAL_POS -1.14f
#define MOTOR_HR_CALF_ANGLE_SPECIAL_POS 2.357f
