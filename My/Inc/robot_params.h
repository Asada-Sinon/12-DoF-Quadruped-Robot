...
#define MOTOR_FL_HIP_ANGLE_SPECIAL_POS 0.3106f
#define MOTOR_FL_THIGH_ANGLE_SPECIAL_POS 1.29f
#define MOTOR_FL_CALF_ANGLE_SPECIAL_POS -2.235f

#define MOTOR_FR_HIP_ANGLE_SPECIAL_POS -0.351f
#define MOTOR_FR_THIGH_ANGLE_SPECIAL_POS -0.99f
#define MOTOR_FR_CALF_ANGLE_SPECIAL_POS 2.064f

#define MOTOR_HL_HIP_ANGLE_SPECIAL_POS -0.3878f
#define MOTOR_HL_THIGH_ANGLE_SPECIAL_POS 1.027f
#define MOTOR_HL_CALF_ANGLE_SPECIAL_POS -2.15f

#define MOTOR_HR_HIP_ANGLE_SPECIAL_POS 0.1759f
