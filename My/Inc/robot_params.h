...
#define MOTOR_FL_HIP_ANGLE_SPECIAL_POS 0.353f
#define MOTOR_FL_THIGH_ANGLE_SPECIAL_POS 1.535f
#define MOTOR_FL_CALF_ANGLE_SPECIAL_POS -2.223f

#define MOTOR_FR_HIP_ANGLE_SPECIAL_POS -0.475f
#define MOTOR_FR_THIGH_ANGLE_SPECIAL_POS -1.06f
#define MOTOR_FR_CALF_ANGLE_SPECIAL_POS 2.079f

#define MOTOR_HL_HIP_ANGLE_SPECIAL_POS -0.2408f
#define MOTOR_HL_THIGH_ANGLE_SPECIAL_POS 1.205f
#define MOTOR_HL_CALF_ANGLE_SPECIAL_POS -2.146f

#define MOTOR_HR_HIP_ANGLE_SPECIAL_POS 0.1768f
#define MOTOR_HR_THIGH_ANGLE_SPECIAL_POS -1.08f
#define MOTOR_HR_CALF_ANGLE_SPECIAL_POS 2.374f
