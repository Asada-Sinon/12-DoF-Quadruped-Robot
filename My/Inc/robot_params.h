...
#define LINK_LENGTH_CALF  0.251f
...
// 前进后退重心偏移量
#define DEFAULT_CENTER_OF_GRAVITY_TROT_COG_FORWARD_OFFSET_X 0.02f
#define DEFAULT_CENTER_OF_GRAVITY_TROT_COG_BACKWARD_OFFSET_X 0.065f
...
#define JOINT_HL_CALF_ANGLE_SPECIAL_POS -27.99f * DEGREE_TO_RADIAN
