...
/* -----------中间变量------------- */
static float Rot_f32[3][3] = {0};
static float u_f32[3] = {0};
static float feetPos_f32[4][3] = {0};
static float feetVel_f32[4][3] = {0};
static float feetZ_f32[4] = {0};
static float Ax_f32[STATE_DIM] = {0};
static float Bu_f32[STATE_DIM] = {0};
static float xhat_f32[STATE_DIM] = {0};
static float yhat_f32[OUTPUT_DIM] = {0};
static float Ppri_f32[STATE_DIM][STATE_DIM] = {0};
static float PpriT_f32[STATE_DIM][STATE_DIM] = {0};
static float AP_f32[STATE_DIM][STATE_DIM] = {0};
static float AT_f32[STATE_DIM][STATE_DIM] = {0};
static float APAT_f32[STATE_DIM][STATE_DIM] = {0};
static float CT_f32[STATE_DIM][OUTPUT_DIM] = {0};
static float CP_f32[OUTPUT_DIM][STATE_DIM] = {0};
static float CPCT_f32[OUTPUT_DIM][OUTPUT_DIM] = {0};
static float RCPCT_f32[OUTPUT_DIM][OUTPUT_DIM] = {0};
static float invRCPCT_f32[OUTPUT_DIM][OUTPUT_DIM] = {0};
static float S_f32[OUTPUT_DIM][OUTPUT_DIM] = {0};
static float ST_f32[OUTPUT_DIM][OUTPUT_DIM] = {0};
static float SL_f32[OUTPUT_DIM][OUTPUT_DIM] = {0};
static float SU_f32[OUTPUT_DIM][OUTPUT_DIM] = {0};
static int LU_P_f32[OUTPUT_DIM] = {0};
static float invSy_f32[OUTPUT_DIM] = {0};
static float y_yhat_f32[OUTPUT_DIM] = {0};
static float invSC_f32[OUTPUT_DIM][STATE_DIM] = {0};
static float invSR_f32[OUTPUT_DIM][OUTPUT_DIM] = {0};
static float invSTC_f32[STATE_DIM][OUTPUT_DIM] = {0};
static float K_f32[STATE_DIM][OUTPUT_DIM] = {0};
static float KT_f32[OUTPUT_DIM][STATE_DIM] = {0};
static float KC_f32[STATE_DIM][STATE_DIM] = {0};
static float I_KC_f32[STATE_DIM][STATE_DIM] = {0};
static float PCT_f32[STATE_DIM][OUTPUT_DIM] = {0};
static float I_KCT_f32[STATE_DIM][STATE_DIM] = {0};
static float I_KCPI_KCT_f32[STATE_DIM][STATE_DIM] = {0};
static float KR_f32[STATE_DIM][OUTPUT_DIM] = {0};
static float KRKT_f32[STATE_DIM][STATE_DIM] = {0};
...
static arm_matrix_instance_f32 CPCT;
static arm_matrix_instance_f32 RCPCT;
static arm_matrix_instance_f32 invRCPCT;
